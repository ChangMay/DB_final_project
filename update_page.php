...
<body>
	<div class = "create">
		<form 
			id = "form"
			method = "get"
			action = "./update_action.php"
		>
			<label for="table">選擇欲更新的table</label>
			...
			<select name="KindOfCar[]" id="KindOfCar" multiple size = "15" required>
				...
				<option value="大型重型機車1(250-550c.c.)">大型重型機車1(250-550c.c.)</option>
				<option value="大型重型機車2(550c.c.以上)">大型重型機車2(550c.c.以上)</option>
